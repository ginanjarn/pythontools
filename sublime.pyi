...
def ok_cancel_dialog(msg: Any, ok_title: str = ...): ...
def yes_no_cancel_dialog(msg: Any, yes_title: str = ..., no_title: str = ...): ...
def run_command(cmd: Any, args: Optional[Any] = ...) -> None: ...
def get_clipboard(size_limit: int = ...): ...
def set_clipboard(text: Any): ...
def log_commands(flag: Any) -> None: ...
def log_input(flag: Any) -> None: ...
def log_result_regex(flag: Any) -> None: ...
def log_indexing(flag: Any) -> None: ...
def log_build_systems(flag: Any) -> None: ...
...
class Window:
    ...
    def show_quick_panel(self, items: Any, on_select: Any, flags: int = ..., selected_index: int = ..., on_highlight: Optional[Any] = ...) -> None: ...
...
class View:
    ...
    def text_point(self, row: Any, col: Any): ...
    def visible_region(self): ...
    def show(self, x: Any, show_surrounds: bool = ...): ...
    ...
    def add_regions(self, key: Any, regions: Any, scope: str = ..., icon: str = ..., flags: int = ...) -> None: ...
    ...
    def assign_syntax(self, syntax_file: Any) -> None: ...
